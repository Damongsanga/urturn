    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http    // REST API이므로 basic auth 및 csrf 보안을 사용하지 않음
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers("/wss/**", "/app/**", "/auth/reissue", "/auth/oauth2/login/github", "/auth/test/login", "/actuator/health", "/swagger-ui/**", "/v3/api-docs/**", "/v3/api-docs", "/auth/oauth2/token").permitAll() ///auth/oauth2/token 삭제 필요
