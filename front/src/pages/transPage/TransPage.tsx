...
import submit from '../../assets/images/submitgif.gif';
	...
	return (
		<>
			<div className='TransPage'>
				<div
					className='TransPageEntire'
					style={{
						backgroundColor: next === 'myPage' ? '#F8F6F8' : 'white',
						border: next === 'myPage' ? '5px solid #F8F6F8' : '5px solid rgba(255, 255, 255, 1)',
					}}
				>
					{contentArray
